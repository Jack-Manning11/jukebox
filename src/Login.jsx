...
const Login = () => {
    ...
    const [memories, setMemories] = useState(['Us driving together, and the tumultuous nature of the relationship (on again off again)',
'Sad memories',
'Being replaced',
'The break up',
...
'This was the first song that made me happy after I was dumped']);
    ...
    const [images, setImages] = useState(['images/0.jpg', 'images/1.jpg']);
